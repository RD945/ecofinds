...
*   **Shopping Cart**: A fully functional shopping cart where users can add, view, and remove items.
...
| `GET`  | `/images/:id`        | None       | Serves a user-uploaded image from the database.       |
